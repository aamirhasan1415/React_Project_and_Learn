          ...
          <div className="w-[100%] md:w-[40%] mt-5 flex flex-col">
            ...
            <div className="flex flex-col p-5 gap-5">
              <div className="flex flex-col">
                ...
                <button className="bg-green-700 hover:bg-green-600 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl">
                  CheckOut Now
                </button>
              </div>
            </div>
